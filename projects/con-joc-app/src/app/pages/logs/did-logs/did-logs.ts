...
@Component({
  ...
  templateUrl: './did-logs.html',
  styleUrl: './did-logs.scss',
})
export class DidLogs {
  ...
  readonly columns: TableColumn[] = [
    ...
    ngOnDestroy(): void {
     ...
     loadReleaseLogs(
      ...
      this.didLogsDataService.getDIDLogs().pipe(takeUntil(this.destroy$)).subscribe({
        next: (res: any) => {
          const fullData = res
        ...
        complete: () => {
          this.didlogConfig.loading = false;
        }
      });
