...
import { ProductComponentDataService } from '../../../data-access/product/product-component/product-component.api';
...
export class ProductComponent {
  ...
  currentSort: Sort = { active: '', direction: '' };
    ...
    { key: 'price_type', label: 'Price Type', sortable: true, searchable: true },
    { key: 'date_created', label: 'Date Created', sortable: true, searchable: true },
    ...
    constructor(private productcomponentDataService:ProductComponentDataService){}
    ngOnInit(){
  ...
  ngOnDestroy(): void {
   ...
   loadProductComponent(
    ...
    this.productcomponentDataService.getProductComponent().pipe(takeUntil(this.destroy$)).subscribe({
      next: (res: any) => {
        const fullData = res
    ...
    this.loadProductComponent(1, this.pageSize, this.currentSearchTerm, sort);
  }

  onPageChange(page: number) {
    this.loadProductComponent(page, this.pageSize, this.currentSearchTerm, this.currentSort);
  }

  onPageSizeChange(size: number) {
    this.loadProductComponent(1, size, this.currentSearchTerm, this.currentSort);
  }

  onSearch(term: string) {
    this.loadProductComponent(1, this.pageSize, term, this.currentSort);
  }
